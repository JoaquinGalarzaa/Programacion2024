...
using Ejercicios_Prueba.Enum;
using Ejercicios_Prueba.Enums;
...
public class ProgramEjercicios
{
    ...
    {
        Gerente Juan = new Gerente("Galarza","Joaquin");
    ...
    private static void Estereo()
    {
        ...
        miEstereo.SeleccionarCancionBT("BT : Imagine Dragons - Believer");
        miEstereo.Mostrar(); 
        ...
        miEstereo.SeleccionarCancionAux("Salida / Abel Pintos - Somos Uno");
        miEstereo.Mostrar();

        miEstereo.EstablecerModo(ModoEstereoEnum.Usb);
        miEstereo.ReproducirDesdeUSB("USB  - Cancion 03 - ACDC Black in Black");
        miEstereo.Mostrar();
    }
